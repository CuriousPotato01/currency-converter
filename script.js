const apiUrl = 'https://api.currencyapi.com/v3/latest?apikey=fca_live_o11BDc1YozMxyr4prwRcuqm4uukWlKCS4YGGMYxe';
...
function updateOutput() {
  ...
  let exchangeRate = currencyData.data[bottomValue].value / currencyData.data[topValue].value;
